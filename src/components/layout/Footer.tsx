          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-20 mb-24">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-10 text-white/70">
                <a href="https://www.instagram.com/modasmelomerezco" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en Instagram" className="hover:text-white transition-colors transform hover:scale-110 duration-200">
                ...
                <a href="https://www.tiktok.com/@modasmelomerezco" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en TikTok" className="hover:text-white transition-colors transform hover:scale-110 duration-200">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 448 512">
                    <path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"/>
                  </svg>
                </a>
                <a href="https://www.facebook.com/profile.php?id=61555721379464" target="_blank" rel="noopener noreferrer" aria-label="Síguenos en Facebook" className="hover:text-white transition-colors transform hover:scale-110 duration-200">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
