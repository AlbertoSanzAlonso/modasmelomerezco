    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-[var(--bg-card)] border border-[var(--border-main)] p-10 rounded-[2.5rem] shadow-sm space-y-6">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-[var(--bg-main)] border border-[var(--border-main)] rounded-2xl px-6 py-4 text-sm font-bold focus:outline-none focus:border-primary/50 transition-all"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                rows={12}
                className="w-full bg-[var(--bg-main)] border border-[var(--border-main)] rounded-2xl px-6 py-4 text-sm font-bold focus:outline-none focus:border-primary/50 transition-all resize-none"
              />
            </div>
