...
export const OrderDetailsModal: React.FC<OrderDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-6 bg-secondary/80 backdrop-blur-sm">
      <div className="bg-[var(--bg-main)] border border-[var(--border-main)] w-full max-w-4xl max-h-[90vh] rounded-[2.5rem] shadow-2xl shadow-primary/5 flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        <header className="p-8 border-b border-[var(--border-main)] flex justify-between items-center bg-[var(--bg-main)]">
          <div>
        ...
        <div className="flex-1 overflow-y-auto p-10 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="space-y-6">
              ...
              <div className="bg-[var(--bg-card)] p-6 border border-[var(--border-main)] rounded-2xl space-y-3">
                <p className="text-sm font-bold text-[var(--text-main)] uppercase italic">{order.customer?.name} {order.customer?.surname}</p>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[var(--bg-card)] p-6 border border-[var(--border-main)] rounded-2xl text-xs text-gray-500 font-bold leading-relaxed space-y-1">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[var(--bg-card)] border border-[var(--border-main)] rounded-2xl overflow-hidden">
              {order.items?.map((item, idx) => (
                <div key={idx} className="p-4 flex items-center gap-4 border-b border-[var(--border-main)] last:border-0">
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-black uppercase italic text-[var(--text-main)]">{item.name}</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-primary/5 p-8 border border-primary/20 rounded-[2rem] space-y-6">
        ...
        <footer className="p-8 border-t border-[var(--border-main)] flex justify-end bg-[var(--bg-main)]">
