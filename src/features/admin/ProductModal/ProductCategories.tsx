  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
      <div className="space-y-6">
        ...
        <select 
          className="w-full bg-(--bg-card) border border-(--border-main) px-6 py-4 text-sm font-bold focus:border-primary outline-none text-(--text-main) rounded-xl cursor-pointer"
          value={categoryId || ''}
