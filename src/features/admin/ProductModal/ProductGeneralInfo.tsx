    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      <div className="space-y-6">
        ...
        <input 
          required
          autoComplete="off"
          className="w-full bg-(--bg-card) border border-(--border-main) px-6 py-4 text-sm font-bold focus:border-primary outline-none normal-case not-italic text-(--text-main) rounded-xl"
          value={name}
