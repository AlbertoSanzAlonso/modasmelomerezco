...
export const ResetPasswordPage: React.FC = () => {
  ...
  if (!email) {
    return (
      <div className="min-h-screen bg-[var(--bg-main)] flex items-center justify-center p-6 text-center transition-colors duration-300">
        <div className="max-w-md space-y-6">
          <h1 className="text-3xl font-display font-black text-[var(--text-main)] uppercase tracking-tighter">Enlace <span className="text-primary italic font-serif lowercase">inválido</span></h1>
      ...
      >
        {isSuccess ? (
          <div className="text-center space-y-6 py-10 animate-fade-in">
            ...
            <h2 className="text-3xl font-display font-black text-[var(--text-main)] uppercase tracking-tighter">Contraseña <span className="text-primary italic font-serif lowercase">actualizada</span></h2>
            <p className="text-gray-500 text-sm">Tu contraseña ha sido cambiada correctamente. Te redirigimos a tu panel...</p>
          </div>
        ) : (
          <>
            <div className="text-center mb-10">
              <h1 className="text-4xl font-display font-black text-[var(--text-main)] uppercase tracking-tighter mb-2">Nueva <span className="italic font-serif lowercase text-primary">contraseña</span></h1>
              ...
              <div className="space-y-4">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="block w-full pl-12 pr-12 py-4 bg-[var(--bg-main)] border border-[var(--border-main)] rounded-2xl text-[var(--text-main)] placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/50 transition-all font-medium"
