        ...
        <div className="space-y-12">
          ...
          <section className="bg-white p-12 shadow-sm border border-secondary/[0.03] space-y-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h2 className="text-xl font-bold tracking-[0.1em] uppercase text-secondary">Tarifa de los envíos</h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <section className="bg-white p-10 shadow-sm border border-secondary/[0.03] space-y-6">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-lg font-bold tracking-[0.1em] uppercase text-secondary">Recogida Local</h2>
              </div>
            ...
            <section className="bg-white p-10 shadow-sm border border-secondary/[0.03] space-y-6">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-lg font-bold tracking-[0.1em] uppercase text-secondary">Punto Nacex</h2>
              </div>
              <p className="text-secondary/80 text-sm leading-relaxed">
          ...
          <section className="bg-secondary text-white p-12 shadow-sm space-y-6">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-xl font-bold tracking-[0.1em] uppercase">¿Cuándo llega mi pedido?</h2>
            </div>
